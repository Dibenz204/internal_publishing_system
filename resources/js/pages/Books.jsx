                                    ...
                                    <tr key={book.id} style={index % 2 === 0 ? styles.trEven : styles.trOdd}>
                                        ...
                                        <td style={{ ...styles.td, whiteSpace: 'nowrap' }}>
                                            <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                                                <button style={styles.viewBtn} onClick={() => setDetailBook(book)}>Chi tiết</button>
                                                {showAssign && (
                                                    <button style={styles.assignBtn} onClick={() => setAssignBook(book)}>Phân công</button>
                                                )}
                                                {showTrack && (
                                                    <button style={styles.trackBtn} onClick={() => navigate(`/books/${book.id}/transfers`)}>Theo dõi</button>
                                                )}
                                            </div>
                                        </td>
                                    </tr>
