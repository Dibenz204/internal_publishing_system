...
//         navigate(`/allocation/${book.project_id}`, {
//             state: { book: book }
//         });
//     };

//     // Handler mới: chuyển đến trang BookTransferDetail
//     const handleViewTransferDetail = (bookId, e) => {
//         e.stopPropagation(); // Không trigger card click
//         navigate(`/books/${bookId}/transfers`);
//     };

//     const handleAssignClick = (projectId, e) => {
//         e.stopPropagation();
...
//         if (book.project_status === 0 || book.project_status === 3) {
//             return null;
//         }
...
//                         onClick={(e) => handleAssignClick(book.project_id, e)}
//                     >
//                         Phân công
//                     </button>
//                 </div>
...
//                             backgroundColor: activeFilter === filter.key ? '#1877f2' : 'white',
//                             color: activeFilter === filter.key ? 'white' : '#555',
//                         }}
